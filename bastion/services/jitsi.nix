{ config, pkgs, lib, ... }: {
  ...
  virtualisation.oci-containers.containers."jitsi-web" = {
    ...
    extraOptions = [
      ...
      "--label"
      "traefik.http.routers.jitsi.rule=Host(`jitsi.bspwr.com`, `jitsi.whimsical.cloud`)"
      "--label"
  ...
  virtualisation.oci-containers.containers."etherpad" = {
    ...
    extraOptions = [
      ...
      "traefik.docker.network=meet.jitsi"
      "--label"
      "traefik.http.routers.etherpad.rule=Host(`etherpad.bspwr.com`, `etherpad.whimsical.cloud`)"
      "--label"
