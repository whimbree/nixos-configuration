{ config, pkgs, lib, ... }: {
  ...
  virtualisation.oci-containers.containers."minecraft-aof6-rcon" = {
    ...
    extraOptions = [
      ...
      "--label"
      "traefik.http.routers.minecraft-aof6-rcon.tls.certresolver=porkbun"
      "--label"
      "traefik.http.routers.minecraft-aof6-rcon.tls.domains[0].main=*.bspwr.com"
      "--label"
      ...
      "--label"
      "traefik.http.routers.minecraft-aof6-rcon-ws.tls.certresolver=porkbun"
      "--label"
      "traefik.http.routers.minecraft-aof6-rcon-ws.tls.domains[0].main=*.bspwr.com"
      "--label"
