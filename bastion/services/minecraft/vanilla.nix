{ config, pkgs, lib, ... }: {
  ...
  virtualisation.oci-containers.containers."minecraft-vanilla-rcon" = {
    ...
    extraOptions = [
      ...
      "--label"
      "traefik.http.routers.minecraft-vanilla-rcon.tls.certresolver=porkbun"
      "--label"
      "traefik.http.routers.minecraft-vanilla-rcon.tls.domains[0].main=*.bspwr.com"
      "--label"
      ...
      "--label"
      "traefik.http.routers.minecraft-vanilla-rcon-ws.tls.certresolver=porkbun"
      "--label"
      "traefik.http.routers.minecraft-vanilla-rcon-ws.tls.domains[0].main=*.bspwr.com"
      "--label"
