{ config, pkgs, lib, ... }: {
  ...
  virtualisation.oci-containers.containers."nextcloud" = {
    ...
    extraOptions = [
      ...
      "--label"
      "traefik.http.routers.nextcloud.rule=Host(`nextcloud.bspwr.com`, `nextcloud.whimsical.cloud`)"
      "--label"
  ...
  virtualisation.oci-containers.containers."nextcloud-collabora" = {
    ...
    extraOptions = [
      ...
      "traefik.docker.network=nextcloud"
      "--label"
      "traefik.http.routers.collabora.rule=Host(`collabora.bspwr.com`, `collabora.whimsical.cloud`)"
      "--label"
  ...
  virtualisation.oci-containers.containers."nextcloud-notify_push" = {
    ...
    extraOptions = [
      ...
      "traefik.docker.network=nextcloud"
      "--label"
      "traefik.http.routers.nextcloud-client-push.rule=Host(`nextcloud.bspwr.com`, `nextcloud.whimsical.cloud`) && PathPrefix(`/push`)"
      "--label"
