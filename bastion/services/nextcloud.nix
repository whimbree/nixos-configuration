{ config, pkgs, lib, ... }: {
  ...
  virtualisation.oci-containers.containers."nextcloud" = {
    ...
    extraOptions = [
      ...
      "--label"
      "traefik.http.routers.nextcloud.tls.certresolver=porkbun"
      "--label"
      "traefik.http.routers.nextcloud.tls.domains[0].main=*.bspwr.com"
      "--label"
  ...
  virtualisation.oci-containers.containers."nextcloud-collabora" = {
    ...
    extraOptions = [
      ...
      "--label"
      "traefik.http.routers.collabora.tls.certresolver=porkbun"
      "--label"
      "traefik.http.routers.collabora.tls.domains[0].main=*.bspwr.com"
      "--label"
  ...
  virtualisation.oci-containers.containers."nextcloud-notify_push" = {
    ...
    extraOptions = [
      ...
      "--label"
      "traefik.http.routers.nextcloud-client-push.tls.certresolver=porkbun"
      "--label"
      "traefik.http.routers.nextcloud-client-push.tls.domains[0].main=*.bspwr.com"
      "--label"
