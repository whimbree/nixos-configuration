...
in {
  ...
  virtualisation.oci-containers.containers."matrix-element" = {
    ...
    extraOptions = [
      ...
      "--label"
      "traefik.http.routers.element.rule=Host(`element.bspwr.com`, `element.whimsical.cloud`)"
      "--label"
  ...
  virtualisation.oci-containers.containers."matrix-element-call" = {
    ...
    extraOptions = [
      ...
      "traefik.docker.network=matrix"
      "--label"
      "traefik.http.routers.element-call.rule=Host(`element-call.bspwr.com`, `element-call.whimsical.cloud`)"
      "--label"
  ...
  virtualisation.oci-containers.containers."matrix-synapse" = {
    ...
    extraOptions = [
      ...
      "traefik.docker.network=matrix"
      "--label"
      "traefik.http.routers.matrix.rule=Host(`matrix.bspwr.com`, `matrix.whimsical.cloud`)"
      "--label"
