{ config, pkgs, lib, ... }: {
  ...
  virtualisation.oci-containers.containers."privoxyvpn-incognito" = {
    ...
    extraOptions = [
      ...
      # quetre
      "--label"
      "traefik.http.routers.quetre.rule=Host(`quetre.bspwr.com`, `quetre.whimsical.cloud`)"
      "--label"
      ...
      # rimgo
      "--label"
      "traefik.http.routers.rimgo.rule=Host(`rimgo.bspwr.com`, `rimgo.whimsical.cloud`)"
      "--label"
      ...
      "--label"
      "traefik.http.routers.i2p-http-proxy.rule=Host(`i2pconsole.local.bspwr.com`, `i2pconsole.local.whimsical.cloud`)"
      "--label"
      ...
      # libreddit
      "--label"
      "traefik.http.routers.libreddit.rule=Host(`libreddit.bspwr.com`, `libreddit.whimsical.cloud`)"
      "--label"
  ...
  virtualisation.oci-containers.containers."metube" = {
    ...
    extraOptions = [
      ...
      "traefik.docker.network=incognito"
      "--label"
      "traefik.http.routers.metube.rule=Host(`metube.bspwr.com`, `metube.whimsical.cloud`)"
      "--label"
  ...
  virtualisation.oci-containers.containers."nitter" = {
    ...
    extraOptions = [
      ...
      "traefik.docker.network=incognito"
      "--label"
      "traefik.http.routers.nitter.rule=Host(`nitter.bspwr.com`, `nitter.whimsical.cloud`)"
      "--label"
  ...
  virtualisation.oci-containers.containers."proxitok" = {
    ...
    extraOptions = [
      ...
      "traefik.docker.network=incognito"
      "--label"
      "traefik.http.routers.proxitok.rule=Host(`proxitok.bspwr.com`, `proxitok.whimsical.cloud`)"
      "--label"
  ...
  virtualisation.oci-containers.containers."searxng" = {
    ...
    extraOptions = [
      ...
      "traefik.docker.network=incognito"
      "--label"
      "traefik.http.routers.searxng.rule=Host(`search.bspwr.com`, `search.whimsical.cloud`)"
      "--label"
