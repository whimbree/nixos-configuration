{ config, pkgs, lib, ... }: {
  ...
  virtualisation.oci-containers.containers."headscale" = {
    ...
    extraOptions = [
      ...
      "--label"
      "traefik.http.routers.headscale.tls.certresolver=porkbun"
      "--label"
      "traefik.http.routers.headscale.tls.domains[0].main=*.bspwr.com"
      "--label"
  ...
  virtualisation.oci-containers.containers."headscale-ui" = {
    ...
    extraOptions = [
      ...
      "--label"
      "traefik.http.routers.headscale-ui.tls.certresolver=porkbun"
      "--label"
      "traefik.http.routers.headscale-ui.tls.domains[0].main=*.bspwr.com"
      "--label"
